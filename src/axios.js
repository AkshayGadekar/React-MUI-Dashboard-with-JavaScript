...
const booleanString = (str) => {
    return str == 'true' ? true : false;
}

let progressBarShouldLoad;
let progressTransitionEnd;
const loadProgressBar = (req, percentCompleted, display) => {
    
    let progressBarNode = document.getElementById("topProgressBar");
    let progressNode = progressBarNode.childNodes[0];
    if (req.progressBarNode) {
        progressBarNode = req.progressBarNode;
        progressNode = progressBarNode.childNodes[0];
    }
...
const completeProgressBarLoading = (progressBarNode, progressNode) => {
